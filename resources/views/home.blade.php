...
@section('content')
<!--Por ejemplo aqui agregamos Home sin toda la extrutura de HTML5-->
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    ...
    <img src="{{asset('images/great-wall.png')}}" class="absolute -right-20 -bottom-20 opacity-20">
</div>
<div class="px-4">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4"> 
        ...
        <a href="{{route('post', $post->slug)}}" class="bg-gray-100 rounded-lg px-6 py-4">
            <p class="text-xs flex items-center gap-2">
                <span class="uppercase text-gray-700 bg-gray-200 roundend-full px-2 py-1">Tutorial</span>
